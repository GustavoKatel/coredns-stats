...
func (_m *StatsBackend) Store(domain string, questionType string, metadata Metadata) {
...
func (_c *StatsBackend_Store_Call) Run(run func(domain string, questionType string, metadata Metadata)) *StatsBackend_Store_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(Metadata))
	})
	return _c
}
...
func (_c *StatsBackend_Store_Call) RunAndReturn(run func(string, string, Metadata)) *StatsBackend_Store_Call {
	_c.Call.Return(run)
	return _c
}
